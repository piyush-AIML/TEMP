...
/** Professor profile (Stage 2) — mirror card + the shared embedded Clerk
 *  portal. Same contract as the student profile: Clerk owns identity, the
 *  mirror refreshes on the next dashboard hit. */
