    ...
    <div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container-site grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-10">
          <Reveal>
            <span className="eyebrow eyebrow-rule text-ec-teal mb-4">
              The idea
            </span>
          ...
          <div className="space-y-5">
            <Reveal delay={80}>
              <p className="type-body-l text-ec-ink dark:text-ec-ink/90 text-pretty">
                A student preparing for an exam may also need help with stress.
                A student learning a language may process information
                differently and need adapted teaching. A school serving all of
                them needs a partner that speaks all five languages.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <p className="type-body-m text-ec-slate text-pretty">
                Educraft was built around that observation. Instead of five
                disconnected course catalogues, we run one ecosystem: shared
                enrolment, shared progress reporting, shared safeguarding, and
                specialists who coordinate with each other about the same
                learner.
              </p>
            </Reveal>
            <Reveal delay={200}>
              <p className="type-body-m text-ec-slate text-pretty">
                The result is what a learner actually needs: continuity. A plan
                that can span language, inclusion, wellbeing, technology, and
                exams without starting over at every handoff.
              </p>
            </Reveal>
          </div>
        </div>
                ...
                >
                  <span
                    className={cn(
                      ...
                      pillarBgClass[p.pillarId],
                    )}
                    aria-hidden="true"
                  />
                  <span
                    className={cn(
                      "block mt-3 type-caption uppercase tracking-[0.08em] font-semibold",
                      pillarTextClass[p.pillarId],
                    )}
                  >
                    {pillars.find((pl) => pl.id === p.pillarId)?.name}
                  </span>
                  <h3 className="type-heading-s text-ec-indigo dark:text-white mt-1">
                    {p.name}
                  </h3>
