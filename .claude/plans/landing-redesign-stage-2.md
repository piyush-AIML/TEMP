...
|---|---|---|
| `docs/projects/landing-redesign/stages/README.md` | The **⚠ join warning**: "The Line layer has no defined join — Stage 2 owns the coordinate system", and "`assertContinuity` cannot be wired as it stands" | **Task 2 (landed)** — replaced with what the join is (`frames.ts`, viewBox selection) and what the seam rule became. Its "Open — decide while planning" list was closed 2026-09-13, when all six items turned out to be decided |
