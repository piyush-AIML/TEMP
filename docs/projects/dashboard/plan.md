The kept roadmap plan for the dashboard module — goals, entities, stack decisions and the stage roadmap, as written; current stage status lives in [`state.md`](state.md).
