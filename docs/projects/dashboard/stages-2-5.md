The implementation guide for dashboard Stages 2–5 (Professor Core → QA & Deploy) — per-stage scope, files and gates; current stage status lives in [`state.md`](state.md).
